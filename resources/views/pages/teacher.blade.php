                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>25 Feb 1979</td>
                                        <td>
                                            <a href="#" class="btn bg-light-green btn-circle waves-effect waves-circle waves-float">
                                                <i class="material-icons">remove_red_eye</i>
                                            </a>
                                            <a href="#" class="btn bg-lime btn-circle waves-effect waves-circle waves-float">
