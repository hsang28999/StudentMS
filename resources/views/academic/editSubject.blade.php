                            ...
                            <form class="form-horizontal" method="POST" action="">
                                            ...
                                            <div class="">
                                                <select name="teacherId" id="">
                                                    @foreach($teacher as $item)
                                                        <option value="{{$item -> teacherId}}" @if($item -> teacherId == $subject -> teachers_teacherId)selected @endif>{{$item -> teacherName}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input value="{{$subject -> passMark}}" name="passMark" step="0.01" type="number" id="" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input value="{{$subject -> finalMark}}" name="finalMark" step="0.01" type="number" id="" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input value="{{$subject -> subjectName}}" name="subjectName" type="text" id="" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
